...
export default function AvailabilityWorkspace({
  ...
  return (
    <div className="relative min-h-0 w-full">
      ...
      <div className="grid min-h-[calc(100vh-120px)] grid-cols-1 gap-3 p-2 sm:gap-4 sm:p-3 lg:h-[calc(100vh-120px)] lg:grid-cols-2 lg:p-4">

        {/* =================================================
            LEFT
        ================================================== */}

        <div className="relative min-h-[500px] min-w-0 lg:min-h-0">
