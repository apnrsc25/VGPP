...
export default function RequirementTable({
   ...
   * SEARCH MODE
   *
   * Search ke waqt hierarchy auto-expand nahi ki jaati.
   * Search results neeche flat Availability-style table
   * mein directly render honge.
   *
   * Search khatam hote hi existing hierarchy render hoti hai.
   * ---------------------------------------------------------
   */
      ...
      <table className="w-full min-w-[680px] table-fixed border-collapse text-[10px] sm:text-[11px]">
        ...
        <tbody>
          {searchActive ? (
             ...
             * SEARCH RESULT VIEW
             *
             * Search active hone par Category/Sub Category
             * rows hide ho jaati hain aur filtered works
             * directly flat list mein show hote hain.
             * =================================================
             */
            sortedWorks.map((work, index) => {
              ...
              return (
                <tr
                  key={`search-work-${work.id}`}
                  className="group h-10 border-b border-[#edf2f5] bg-white text-[#334155] transition hover:bg-[#f8fbfd] "
                >
                  {/* WORK NAME */}
